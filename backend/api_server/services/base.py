...
# TypeVar for ORM model types - allows generic typing for database models
# This enables type hints that work with any SQLAlchemy model class
ORMModel = TypeVar("ORMModel")
# TypeVar for create schema types - allows generic typing for create operations
# This ensures that the create operation uses a pydantic BaseModel
...
class BaseService:
    ...
    def __init__(self, model: Type[ORMModel]) -> None:
        ...
        Parameters:
            ...
            To see models go to api_server.models module.
        """
        self._model = model
    ...
    def create_with_owner(
        ...
        """Create a new record with owner in the database.
